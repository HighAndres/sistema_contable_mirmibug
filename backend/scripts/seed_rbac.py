...
PERMISOS: dict[str, str] = {
    ...
    "cfdi.editar": "Clasificar facturas (deducible / no deducible / deducción personal, concepto y cuenta contable) y marcarlas a mano como pagadas/cobradas",
    "reportes.leer": "Ver reportes y dashboard fiscal",
    "nomina.leer": "Ver datos de nómina (sueldos, CURP, NSS y cuenta bancaria de los trabajadores)",
    "impuestos.leer": "Ver la previa de IVA e ISR por periodo",
    "conciliacion.leer": "Ver la conciliación bancaria y fiscal",
    "conciliacion.gestionar": "Cuentas bancarias, importar estados de cuenta, conciliar y capturar declaraciones",
    "terceros.leer": "Ver clientes y proveedores",
    "terceros.gestionar": "Crear/editar clientes y proveedores, detectar desde CFDI y cargar por Excel",
    "inventario.leer": "Ver inventario",
    "inventario.ajustar": "Registrar movimientos de inventario",
    "pedimentos.leer": "Ver pedimentos de importación y su costeo",
    "pedimentos.gestionar": "Importar/capturar pedimentos, configurar el costeo y aplicarlos al inventario",
